        ...
        <div className={s.accessSection}>
            ...
            <div className={s.attention}>
                ...
                <div className={s.attentionContent}>
                    ...
                    <p>Это значит, что если вы выдадите доступ из этого раздела, то пользователь может получить доступ ко всем данным из панели администратора, в том числе к заявкам и данным компаний. Если вы хотите зарегистрировать клиента, перейдите в раздел "Клиенты".</p>
                </div>
                <button onClick={() => navigate('/admin/clients')} className={s.attentionButton}>Перейти в раздел "Клиенты"</button>
            </div>
